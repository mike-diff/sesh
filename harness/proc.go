...
// a stable per-process token that distinguishes a recycled pid.
...
// group, read from /proc (no lsof/ss dependency). Best-effort: any parse
// failure yields no port rather than a wrong one.
